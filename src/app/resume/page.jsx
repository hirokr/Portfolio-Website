...
const Resume = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { delay: 0.1, ease: "easeIn" } }}
      ...
      <div className='container mx-auto'>
        ...
        >
          ...
          <div className='min-h-[70vh] w-full'>
                    ...
                    return (
                      <li key={index} className=''>
                        <TooltipProvider className delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger className='w-full h-[150px] bg-[#232339] flex rounded-xl justify-center items-center group'>
                              <div className='text-6xl group-hover:text-accent transition-all divide-fuchsia-300'>
                                {skill.icon}
                              </div>
                            </TooltipTrigger>
                            <TooltipContent>
            ...
            >
              <div className="flex flex-col gap-[30px]">
                <h3 className="tex-4xl font-bold">{about.title}</h3>
